...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <body style="background: url(Job-Board-Header-Background.png); background-size:cover;">
    <div class="container">
  ...
  "><br> -->
        ...
        <form action="userlogin.php" method="post">
         ...
         <!-- <p class="input-group" style=" margin: 7px -13px 31px -13px;">
          ...
          <div class="signup-link" style="color: black;">Not a member? <a href="hubspotsign.html">Signup now</a></div>
        </form>
      </div>
    </div>
